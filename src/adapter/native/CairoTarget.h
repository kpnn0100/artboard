...
namespace artboard
{
    ...
    public:
        ...
        double measureText(const std::string &text, double sizePx,
                           const std::string &fontFamily = "", double letterSpacingPx = 0.0) const override;
    ...
    private:
        ...
        int mNextImageId = 1;
        std::vector<double> mLayerAlphas;  // LIFO: alpha for each open pushLayer, by nesting depth
    };
}